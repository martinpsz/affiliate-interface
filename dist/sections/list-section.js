            ...
            <section>
                ${this._initialListSize >= 24 ? html `
                    <div class="list-filter">
                        ...
                        <radio-input darkMode prompt="Status:" .labels=${['All', 'Needs Review', 'Submitted', 'Active']} .defaultCheck=${this._statusSelected} @retrieve-selection=${this._updatedStatusSelection}></radio-input>
